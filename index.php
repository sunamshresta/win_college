...
<body>
  ...
  <?php require 'includes/main_banner.php'; ?>
          ...
          <div class="features-post">
            <div class="features-content">
              ...
              <div class="content-hide">
                ...
                <!-- <div class="scroll-to-section"><a href="course.php">View All.</a></div> -->
                <a href="pages/course.php">View All.</a>
            </div>
            </div>
          </div>
        </div>
  ...
  <?php require 'includes/courses.php'; ?>
