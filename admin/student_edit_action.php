...
if(isset($_POST['edit-btn']))
{
    ...
    $detail_query="UPDATE student_details set first_name='$firstName', middle_name='$middleName', last_name='$lastName', gender='$gender', dob='$dob', address1='$address1', address2='$address2', email='$email', mobile='$mobile' where id=$id;";
