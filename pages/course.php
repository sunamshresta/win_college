        ...
        <div class="owl-carousel owl-theme">
          <div class="item">
            ...
            <div class="down-content">
              <h4>Certificate IV in IT</h4>
              <h6>• ICT Course</h6>
              <p>Certificate IV in IT</p>
          ...
          <div class="item">
            ...
            <div class="down-content">
              <h4>Diploma of Screen & Media</h4>
              <h6>• ICT Course</h6>
              <p>Diploma of Screen & Media.</p>
              <div class="author-image">
          ...
          <div class="item">
            ...
            <div class="down-content">
              <h4>Advanced Diploma of IT</h4>
              <h6>• ICT Course</h6>
              <p>Advanced Diploma of IT.</p>
              <div class="author-image">
          ...
          <div class="item">
            ...
            <div class="down-content">
              <h4>Certificate IV in Business Management</h4>
              <h6>• Business Course</h6>
              <p>Certificate IV in Business Management.</p>
              <div class="author-image">
          ...
          <div class="item">
            ...
            <div class="down-content">
              <h4>Diploma of Leadership & Management</h4>
              <h6>• Business Course</h6>
              <p>Diploma of Leadership & Management.</p>
              <div class="author-image">
          ...
          <div class="item">
            ...
            <div class="down-content">
              <h4>Advanced Diploma of Leadership & Management</h4>
              <h6>• Business Course</h6>
              <p>Advanced Diploma of Leadership & Management.</p>
              <div class="author-image">
          ...
          <div class="item">
            ...
            <div class="down-content">
              <h4>Certificate IV in Accounting</h4>
              <h6>• Business Course</h6>
              <p>Certificate IV in Accounting.</p>
              <div class="author-image">
          ...
          <div class="item">
            <img src="../assets/images/courses-05.jpg" alt="">
            <div class="down-content">
              <h4>Diploma of Project Management</h4>
              <h6>• Business Course</h6>
              <p>Diploma of Project Management.</p>
              <div class="author-image">
                <img src="../assets/images/author-05.png" alt="">
              </div>
              <div class="text-button-free">
          ...
          <div class="item">
            <img src="../assets/images/courses-01.jpg" alt="">
            <div class="down-content">
              <h4>Diploma of Financial Planning</h4>
              <h6>• Business Course</h6>
              <p>Diploma of Financial Planning.</p>
              <div class="author-image">
                <img src="../assets/images/author-01.png" alt="">
              </div>
              <div class="text-button-pay">
